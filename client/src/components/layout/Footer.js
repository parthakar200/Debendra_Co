      ...
      <div style={{ borderTop: '1px solid #1e293b' }}>
        <div className="container" style={{ padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
          <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap' }}>
            <a href="tel:+8018429212" style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, color: '#64748b', transition: 'color 0.15s' }}
            ...
            <a href="mailto:debendrabarik783@gmail.com" style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, color: '#64748b', transition: 'color 0.15s' }}
              onMouseEnter={e => e.currentTarget.style.color = '#60a5fa'}
              onMouseLeave={e => e.currentTarget.style.color = '#64748b'}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>
              debendrabarik783@gmail.com
            </a>
          </div>
          <p style={{ fontSize: 13, color: '#475569' }}>
            © {new Date().getFullYear()} Debendra & Co. All rights reserved.
          </p>
        </div>
      </div>
