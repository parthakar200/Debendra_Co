  ...
  return (
    <div style={{ paddingTop: 'var(--nav-height)', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '48px 24px', maxWidth: 800 }}>
        {[
          { title: '1. Acceptance of Terms', content: 'By accessing and using the Debendra & Co. platform, you accept and agree to be bound by the terms and provision of this agreement. In addition, when using Debendra & Co. services, you shall be subject to any posted guidelines or rules applicable to such services.' },
          { title: '2. Services', content: 'Debendra & Co provides online corporate and compliance services including but not limited to company registration, GST filing, trademark registration, and income tax filing. All services are subject to applicable government regulations and fees.' },
          ...
          { title: '5. Privacy', content: 'Your use of Debendra & Co. is also governed by our Privacy Policy, which is incorporated into these terms by reference. We collect and process your personal data in accordance with applicable data protection laws.' },
          { title: '6. Limitation of Liability', content: 'Debendra & Co. shall not be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses resulting from your use of the service.' },
    ...
    <div style={{ paddingTop: 'var(--nav-height)', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '48px 24px', maxWidth: 800 }}>
        {[
          ...
          { title: 'Your Rights', content: 'You have the right to access, correct, or delete your personal information. You may also object to processing or request data portability. Contact us at privacy@Debendraco.com to exercise these rights.' },
          { title: 'Contact Us', content: 'For privacy-related queries, contact our Data Protection Officer at privacy@debendraco.com or write to Debendra & Co., No.1, 8th Floor, Arihant Nitco Park, Rajiv Gandhi Salai, Perungudi, Chennai – 600096.' },
        ].map(section => (
          <div key={section.title} style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 10, color: '#0f172a' }}>{section.title}</h2>
            <p style={{ fontSize: 15, color: '#475569', lineHeight: 1.8 }}>{section.content}</p>
